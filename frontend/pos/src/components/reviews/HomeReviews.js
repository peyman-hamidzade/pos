                ...
                <div className="col-span-12 md:col-span-5 relative">
                    <div className="leading-8">
                        <h2 className="font-YekanBakh-ExtraBlack text-3xl my-4">از زبان مشتریان ما بشنوید...</h2>
                         <p className="mb-4">استفاده از خدمات این وبسایت برای فروشگاه ما یک تجربه عالی بود. کارتخوانی که از آن استفاده می‌کنیم به بهترین شرایط ممکن به ما ارائه شد و فرآیند ثبت آن بسیار آسان... </p>
                        ...
                        <SwiperSlide>
                          <div className="swiper-slide">
                            <div className="bg-white p-6 leading-8 rounded-3xl">
                                ...
                                <p>استفاده از خدمات این وبسایت برای فروشگاه ما یک تجربه عالی بود. کارتخوانی که از آن استفاده می‌کنیم به بهترین شرایط ممکن به ما ارائه شد و فرآیند ثبت آن بسیار آسان بود. تیم فنی آن‌ها نیز بسیار حرفه‌ای عمل کرد و مشکلات ما را به سرعت حل کردند. با اطمینان توصیه می‌کنم.</p>
                            </div>
                          </div>
                        </SwiperSlide>
                        ...
                        <SwiperSlide>
                          <div className="swiper-slide">
                            <div className="bg-white p-6 leading-8 rounded-3xl">
                                ...
                                <p>من به تازگی کارتخوانم را تعمیر کردم و بسیار راضی هستم. خدمات تعمیری که این وبسایت ارائه می‌دهد بسیار حرفه‌ای است. کارتخوان من به بهترین شرایط ممکن تعمیر شد و اکنون بدون هیچ مشکلی کار می‌کند. از تیم فنی آن‌ها بسیار سپاسگزارم.</p>
                            </div>
                          </div>
                        </SwiperSlide>
                        ...
                        <SwiperSlide>
                          <div className="swiper-slide">
                            <div className="bg-white p-6 leading-8 rounded-3xl">
                                ...
                                <p>تجربه من با این وبسایت بسیار مثبت بود. خرید کارتخوان از آن‌ها بسیار آسان بود و کارتخوانی که دریافت کردم عالی عمل می‌کند. همچنین خدمات پس از فروش آن‌ها بسیار قابل تحسین است. با اطمینان به دوستان و همکارانم این وبسایت را توصیه می‌کنم.</p>
                            </div>
                          </div>
                        </SwiperSlide>
                        ...
                        <SwiperSlide>
                          <div className="swiper-slide">
                            <div className="bg-white p-6 leading-8 rounded-3xl">
                                ...
                                <p>من از خدمات این وبسایت برای ثبت کارتخوان خود استفاده کردم و بسیار راضی بودم. فرآیند ثبت بسیار ساده بود و تیم پشتیبانی آن‌ها همیشه آماده پاسخگویی به سوالات من بودند. توصیه می‌کنم به همه کسانی که به دنبال خدمات مرتبط با کارتخوان هستند.</p>
                            </div>
                          </div>
                        </SwiperSlide>
